...
var cor3 = randomColor()
var cor4 = randomColor()	
var cor5 = randomColor()
var cor6 = randomColor()
...
$("#bgpicker1").css('background-color', cor6);
$("#bgpicker2").css('background-color', cor3);
$("#bgpicker3").css('background-color', cor1);
$("#bgpicker4").css('background-color', cor5);
$("#bgpicker5").css('background-color', cor2);
$("#bgpicker6").css('background-color', cor4);
$("#bgpicker7").css('background-color', cor0);
